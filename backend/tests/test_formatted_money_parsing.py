                    ...
                    "content": [
                        {
                            "text": json.dumps(
                                {
                                    "summary": {
                                        "oneLineDiagnosis": "Formatted money smoke test AI response.",
                                        "topPriorities": ["Validate formatted money parsing"],
                                    },
                                    "plan": {"actionPlan": ["Formatted money parsing passed."]},
                                }
                            )
                        }
                    ]
...
def test_formatted_money_values_are_not_zero():
    payload = {
        "basics": {
            "age": "34",
            ...
            "kids": [{"name": "Child 1", "age": "5"}],
            "parentsDependent": True,
            "dependentParentsCount": "2",
        },
        "income": {
            "monthlyAfterTax": "2,10,000",
            "bonusAnnual": "2,00,000",
            "otherMonthly": "10,000",
        },
        "expenses": {
            "fixed": "80,000",
        ...
        "salary": {
            ...
            "hraReceived": "4,80,000",
            "grossEarning": "30,18,000",
            "epfContribution": "1,44,000",
            "npsEmployer": "1,20,000",
            "rentPaid": "7,20,000",
            "profTax": "2,400",
            "incomeTax": "3,00,000",
        },
        ...
        "goals": [
            {"name": "Home", "category": "home", "presentCost": "25,00,000", "years": "5", "inflationPct": "6", "expectedReturnPct": "9", "priority": "High"}
        ],
    }
    ...
    assert summary["monthlySurplus"] == 60000.0, summary
    ...
    assert any(float(g.get("futureCost") or 0) > 0 for g in goals), goals


if __name__ == "__main__":
    test_formatted_money_values_are_not_zero()
    print("formatted money parsing smoke test passed")
